...
class Frontpage_post(db.Model):
    ...
    def generate_data():
        ...
        post5 = Frontpage_post(title="du er verdt det", body_text="det er på tide å stå opp, se seg selv i speilet og si 'gjør det heller i morgen, fordi du fortjener det'",author=1,image="https://mdbootstrap.com/img/Photos/Others/images/11.jpg" )
        post6 = Frontpage_post(title="tingen er å ha det", body_text="mange klager på å ikke ha ting, og det er da såklart et problem som kan påvirke hverdagen fra en tid til en annen når man minst tenker på det. gjerrr det bish", image="https://mdbootstrap.com/img/Photos/Others/images/12.jpg")
